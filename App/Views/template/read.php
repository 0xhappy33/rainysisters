                            ...
                            <ul class="social">
                                <li>
                                    <div class="like wow rotateIn" data-wow-offset="0">
                                        <a href="#">
                                            <span class="fa fa-thumbs-o-up" title="Like"></span>
                                        </a>
                                    </div>
                                </li>
                                <li>
                                    <div class="heart wow rotateIn">
                                        <a href="#">
                                            <span class=" fa fa-heart-o" title="Love"></span>
                                        </a>
                                    </div>
                                </li>
                                <li>
                    ...
                    <div class="col-md-8 col-xs-10 col-sm-8">
                        <div>
                                ...
                                <div class="col-md-11">
                                    ...
                                    <div class="reviewer-info">
                                        <p>
                                            ...
                                            farnamstreetblog.com@farnamstreet
                                        </p>
                                    </div>
                            ...
                            <div class="main-content">
                                ...
                                <p>
                                    Below are three strategies, pulled from an interview he gave on
                                    <a href="#" target="_blank">FarnamStreet’s podcast The Knowledge Project</a>
                                    ,that will help you see reality, find clarity, and make better decisions.
                                </p>
                                ...
                                <div class="content-review  wow rollIn">
                                    ...
                                    <p>Below are three strategies, pulled from an interview he gave on
                                        ...
                                        </a>,that will help you see reality, find clarity, and make better decisions
                                    </p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p>I’ve created a mailing list that helps people get better results through better
                                        decisions.</p>
                                    <a href="#" data-href="https://www.farnamstreetblog.com/newsletter/"
                                       target="_blank">Get it right here.</a>
                                </div>

                                <hr class="section-divider">

                                <div class="note">
                                    <h4 name="1b7f" id="1b7f" class="graf graf--h4 graf--leading">
                                ...
                                <div>
                                    ...
                                    <ul class="tag wow bounceInLeft">
                                        ...
                                        <li>
                                            <a class="link u-baseColor--link" href="#">Life Lessons</a>
                                        </li>
                                        <li>
                                            <a class="link u-baseColor--link" href="#">Self Improvement</a>
                                        </li>
                                        <li>
                                            <a class="link u-baseColor--link" href="#">Life</a>
                                        </li>
                                    </ul>
                                </div>
