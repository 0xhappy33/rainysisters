                        ...
                        <div class="col-md-offset-3 col-xs-12 col-sm-off-3 col-lg-offset-3">
                            ...
                            <form  action="mysuperscript.php" autocomplete="on">
                                ...
                                <p>
                                    ...
                                    <input id="username" name="username" required="required" type="text" placeholder="nuongnguyen or nuong14pt@gmail.com"/>
                                </p>
                                <p>
                        ...
                        <div id="register" class="animate form">
                            <form  action="mysuperscript.php" autocomplete="on">
                                ...
                                <p>
                                    ...
                                    <input id="usernamesignup" name="usernamesignup" required="required" type="text" placeholder="nuongnguyen1996" />
                                </p>
                                <p>
                                    <label for="emailsignup" class="youmail"  > Your email</label>
                                    <input id="emailsignup" name="emailsignup" required="required" type="email" placeholder="nuong14pt@mail.com"/>
                                </p>
                                <p>
