        ...
        <div class="container-fluid " id="wrapper">
                        ...
                        <div>
                            <div class="row">
                                ...
                                <div class="col-md-11">
                                    ...
                                    <div>
                                        <p class="reviewer-info">Trying to understand how the world works
                                            farnamstreetblog.com @farnamstreet</p>
                                    </div>
                            ...
                            <div class="main-content">
                                ...
                                <h1 class="wow lightSpeedIn" data-wow-duration="2s">Three Lessons From Ray Dalio that
                                    will Immediately Improve your&nbsp;Life</h1>
                                <!-- Gioi thieu ve sach -->

                                <p>Ray Dalio wasn’t always a billionaire. In fact, he punched his boss in the face,
                                    nearly went broke multiple times, and ran a fledgling business from a two-bedroom
                                    apartment in New York.</p>
                                <p>What he was doing wasn’t working. But unlike most people, when the chips were down,
                                ...
                                <p>Below are three strategies, pulled from an interview he gave on
                                    <a href="https://www.farnamstreetblog.com/2017/10/ray-dalio/"
                                       data-href="https://www.farnamstreetblog.com/2017/10/ray-dalio/" target="_blank">Farnam
                                        Street’s podcast The Knowledge Project</a>
                                ...
                                <div class="content-review wow rollIn">
                                    ...
                                    <!-- main -review -->
                                    <em>“An idea meritocracy is when the best ideas win out, and the way that you have
                                        to have it… There are three steps that you have to do. First, you have to put
                                        your honest thoughts out there.&nbsp;… Second, you have to have thoughtful
                                        disagreement.&nbsp;… (Third) you have to have ways that if disagreements remain,
                                        that you think are fair, appropriate, agreed-upon ways of getting past that
                                        disagreement because not everybody’s going to get what they want.”</em>

                                    <p>Ray Dalio wasn’t always a billionaire. In fact, he punched his boss in the face,
                                        nearly went broke multiple times, and ran a fledgling business from a
                                        two-bedroom apartment in New York.</p>
                                    <p>What he was doing wasn’t working. But unlike most people, when the chips were
                                        down, Ray didn’t blame the world. Rather, he confronted reality and vowed to
                                        change.</p>
                                    <p>Below are three strategies, pulled from an interview he gave on
                                        <a href="https://www.farnamstreetblog.com/2017/10/ray-dalio/"
                                           data-href="https://www.farnamstreetblog.com/2017/10/ray-dalio/"
                                           target="_blank">Farnam Street’s podcast The Knowledge Project</a>
                                        , that will help you see reality, find clarity, and make better decisions.</p>
                                ...
                                <div>
                                    ...
                                    <p>I’ve created a mailing list that helps people get better results through better
                                        decisions.</p>

                                    <a href="https://www.farnamstreetblog.com/newsletter/"
                                       data-href="https://www.farnamstreetblog.com/newsletter/" target="_blank">Get it
                                        right here.</a>
                                </div>
                                <div>
                                ...
                                <div class="note">
                                    <h4 name="1b7f" id="1b7f" class="graf graf--h4 graf--leading">If you enjoyed this
                                        story, please click the 👏 <span class="glyphicon glyphicon-apple"></span>
                                    ...
                                    <h4>The Mission publishes stories, videos, and podcasts that make smart people
                                        smarter. By subscribing and sharing, you will be entered to win three (super
                                        awesome)&nbsp;prizes!</h4>
                                </div>
                                ...
                                <div>
                                    ...
                                    <ul class="tag wow bounceInLeft">
                                        ...
                                        <li>
                                            <a href="https://medium.com/tag/entrepreneurship?source=post">
                                                Entrepreneurship
                                            </a>
                                        </li>
                                        <li>
                                            <a class="link u-baseColor--link"
                                               href="https://medium.com/tag/life-lessons?source=post">
                                                Life Lessons
                                            </a>
                                        </li>
                                        <li>
                                            <a class="link u-baseColor--link"
                                               href="https://medium.com/tag/self-improvement?source=post">Self
                                                Improvement
                                            </a>
                                        </li>
                                        <li>
                                            <a class="link u-baseColor--link"
                                               href="https://medium.com/tag/life?source=post">Life
                                            </a>
                                        </li>
                                    </ul>
            ...
            <div class="row">
                ...
                <div class="col-md-offset-2">
                    ...
                    <div class="comment">
                        <a href="#"><img src="../images/lanhuong.jpg" alt="not load picture"
                                         title="click here to see more infomation"></a>
		...
		<div class="row">
			...
			<div class="col-md-8 col-xs-10 col-sm-8">
				...
				<div>
					<div class = "row">
						<div class="col-md-1">
							<img src="../images/anh1.png" class="avatar-image avatar-image--small" alt="Go to the profile of user">
					...
					<div class = "pic">
						<img src="../images/anh1.png" alt=""  max-width="100%">
						<figcaption class="detail-user">Photo via Shane&nbsp;Parrish</figcaption>
					</div>
					<div class = "main-content">
					<!-- Tieu de sach -->
			...
			<!-- chia se, like, tym,... -->
					<!-- 	<div calss = "social">
							...
							<div class ="col-md-offset-10 col-xs-offset-10 col-sm-offset-10">
								<div class="like wow rotateIn"><a href="">
			...
			<div id="content-bottom">
				<center>
					...
					<div class="col-md-4 col-xs-4 col-sm-4 item-review">
						...
						</div><div class="col-md-4 col-xs-4 col-sm-4 item-review">
							<div class="bac" style = " background-image: url('../images/anh1.png'); ">
							<!-- ??? -->
...
<!-- end relation cat -->
				...
				<div class="row">
					...
					<div class="col-md-offset-3 col-xs-12 col-sm-offset-3">
						<!-- comment -->
					<div class="cmt">
						<h3 >Comment</h3>
					</div>
...
<div class="top">
	...
	<?php include 'footer.php'; ?>
	<?php include 'script.php'; ?>
>>>>>>> 08dfe4629ec174a07e4b567d9ebb407e7f186c23
</body>
